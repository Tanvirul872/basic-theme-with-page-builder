...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'redapple' ),
		__( 'Previous', 'redapple' ),
		__( 'Next', 'redapple' ),
		__( 'About:', 'redapple' ),
		__( 'Profile', 'redapple' ),
		__( 'Posts by', 'redapple' ),
		__( 'Permanent Link:', 'redapple' ),
		__( 'in', 'redapple' ),
		__( 'Edit', 'redapple' ),
	);
}
