...
if ( ! function_exists( 'understrap_all_excerpts_get_more_link' ) ) {
	...
	function understrap_all_excerpts_get_more_link( $post_excerpt ) {
		if ( ! is_admin() ) {
			$post_excerpt = $post_excerpt . ' [...]<p><a class="btn btn-secondary redapple-read-more-link" href="' . esc_url( get_permalink( get_the_ID() ) ) . '">' . __(
				'Read More...',
				'redapple'
			) . '</a></p>';
		}
