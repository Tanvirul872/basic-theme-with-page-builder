	...
	function understrap_pagination($args = array(), $class = 'pagination')
	{
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __('&laquo;', 'redapple'),
				'next_text'          => __('&raquo;', 'redapple'),
				'type'               => 'array',
				'current'            => max(1, get_query_var('paged')),
				'screen_reader_text' => __('Posts navigation', 'redapple'),
			)
		);
...
?>
		...
		<div class="col-12">
			<div class="r_news_paginatiom">
				<label class="r_news_pagi_title">pagina</label>
